...
public class AlbumServiceImpl implements com.codegym.spotify.service.AlbumService {
    ...
    @Override
    public List<AlbumDto> findAlbumsByName(String keyword) {
        List<Album> albums = albumRepository.findAlbumsByTitleContainsIgnoreCase(keyword);
    ...
    @Override
    public void editAlbum(AlbumDto albumDto, Long albumId) {
        Album album = convertToAlbumEntity(albumDto);
        album.setId(albumId);
        albumRepository.save(album);
    }
